...
- some endertrees generate (so you can make tools to break out of a stone-layer
that you spawned in when entering a one-way-portal)
- to make tools of stone you have to go to the overworld by design
...
### enderworld
- lead to the overworld
- every block in the overworld corresponds to a chunk in the enderworld
...
- Players need an enderpearl to teleport that is consumed
...
- wither roses can be placed on nether bricks
...
to "remember" one location (shouldn't be possible)
- the endermans has to spawn very rarely in the enderworld so
the eating nerf is actually a huge nerf
- taking with you villagers, players and animals is wanted

# abilities
- can build structures and activate them using the primary ability, they use up ender essence
