...
import com.gmail.guitaekm.technoenderling.worldgen.structures.StandardStructure;
...
public class ModStructureFeatures {
    ...
    public static void register() {
        ...
        // It has many options to make sure your structure will spawn and work properly.
        // Give it your structure and the identifier you want for it.
        FabricStructureBuilder.create(new Identifier(TechnoEnderling.MOD_ID, "enderworld_portal"), ENDERWORLD_PORTAL)
        ...
        // It has many options to make sure your structure will spawn and work properly.
        // Give it your structure and the identifier you want for it.
        FabricStructureBuilder.create(new Identifier(TechnoEnderling.MOD_ID, "one_way_portal"), ONE_WAY_PORTAL)
