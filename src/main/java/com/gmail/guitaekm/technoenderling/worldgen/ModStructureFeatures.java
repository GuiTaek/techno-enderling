...
public class ModStructureFeatures {
     ...
     */
    public static StructureFeature<StructurePoolFeatureConfig> POCKET_PORTAL = new PocketPortalStructure(StructurePoolFeatureConfig.CODEC);
    ...
    public static void register() {
        ...
        FabricStructureBuilder.create(new Identifier(TechnoEnderling.MOD_ID, "pocket_portal"), POCKET_PORTAL)
