...
import com.gmail.guitaekm.technoenderling.worldgen.structures.PocketPortalStructure;
...
public class ModStructureFeatures {
     ...
     */
    public static StructureFeature<StructurePoolFeatureConfig> COMMON_POCKET_PORTAL = new PocketPortalStructure(StructurePoolFeatureConfig.CODEC);
    public static StructureFeature<StructurePoolFeatureConfig> RARE_POCKET_PORTAL = new PocketPortalStructure(StructurePoolFeatureConfig.CODEC);
    ...
    public static void register() {
        ...
        FabricStructureBuilder.create(new Identifier(TechnoEnderling.MOD_ID, "common_pocket_portal"), COMMON_POCKET_PORTAL)
        ...
        // It has many options to make sure your structure will spawn and work properly.
        // Give it your structure and the identifier you want for it.
        FabricStructureBuilder.create(new Identifier(TechnoEnderling.MOD_ID, "rare_pocket_portal"), RARE_POCKET_PORTAL)
