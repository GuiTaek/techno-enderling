...
public class RegisterModStructures {
    ...
    public static List<Identifier> rarePocketPortalBiomes = List.of(
            new Identifier(EnderGenesis.MOD_ID, "enderworld_wastes"),
            new Identifier(EnderGenesis.MOD_ID, "enderworld_forest")
    );

    public static List<Identifier> commonPocketPortalBiomes = List.of(
            new Identifier(EnderGenesis.MOD_ID, "enderworld_foggy_forest")
    );
    ...
    public static void addToBiomes() {
        ...
        BiomeModifications.addStructure(
                ...
                RegistryKey.of(
                        ...
                        new Identifier(EnderGenesis.MOD_ID, "common_pocket_portal")
                )
        );
        ...
        BiomeModifications.addStructure(
                ...
                RegistryKey.of(
                        Registry.CONFIGURED_STRUCTURE_FEATURE_KEY,
                        new Identifier(EnderGenesis.MOD_ID, "rare_pocket_portal")
                )
        );
        ...
        BiomeModifications.addStructure(
                ...
                RegistryKey.of(
                        Registry.CONFIGURED_STRUCTURE_FEATURE_KEY,
                        new Identifier(EnderGenesis.MOD_ID, "enderworld_portal")
                )
        );
        ...
        BiomeModifications.addStructure(
                ...
                RegistryKey.of(
                        Registry.CONFIGURED_STRUCTURE_FEATURE_KEY,
                        new Identifier(EnderGenesis.MOD_ID, "enderman_enderworld")
                )
        );
        ...
        BiomeModifications.addStructure(
                ...
                RegistryKey.of(
                        Registry.CONFIGURED_STRUCTURE_FEATURE_KEY,
                        new Identifier(EnderGenesis.MOD_ID, "one_way_portal")
                )
        );
    }
